...
import (
	...
	"sync"
	"time"
	breaker "github.com/Shopify/sarama/vz/breaker"
...
func NewClient(addrs []string, conf *Config) (Client, error) {
	...
	// Create VZ breaker topic/partition channel
	if true == config.AvailMonFeature {
		breaker.VzBrTopPartSt = make (chan *breaker.VzBreakerTopicPartStatus, 64)
	}
